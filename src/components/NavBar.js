    ...
    <div>
      <nav className="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        <div className="container-fluid">
          ...
          <Link className="navbar-brand" to="/"><img src={logo} alt="Head News" width = "220rem" height = "70rem"/></Link>
          <div style={{color: 'white', fontSize: '0.7em'}}>{time.toLocaleString().substring(0,9).toUpperCase()}<br/><br/>{time.toLocaleString().substring(11).toUpperCase()}</div>
